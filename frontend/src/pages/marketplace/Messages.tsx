// src/pages/Messages.tsx - PROFESSIONAL & MODERN VERSION
...
const Messages: React.FC = () => {
  ...
  // Initialize currentUser from auth context immediately
  useEffect(() => {
    if (authUser) {
      setCurrentUser({
  ...
  // Fetch user details only if not in auth context
  useEffect(() => {
  ...
  const renderEmptyState = () => (
    <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
      <div className="w-24 h-24 bg-gradient-to-br from-gray-50 to-gray-100 rounded-full flex items-center justify-center mb-5 border border-gray-200">
      ...
      <p className="text-gray-600 max-w-md mb-7 text-sm leading-relaxed">
      ...
      <div className="flex gap-3">
        <button
          ...
          className="px-5 py-2.5 bg-gray-900 text-white text-sm font-medium rounded-lg hover:bg-black transition-colors flex items-center shadow-sm"
        >
      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="bg-white rounded-xl border border-gray-200 h-[calc(100vh-180px)] flex overflow-hidden shadow-sm">
            {/* Chat List - Left Panel (Wider) */}
            <div className={`w-full lg:w-1/3 xl:w-1/4 border-r border-gray-200 flex flex-col ${!showChatListMobile && selectedChat ? 'hidden lg:flex' : 'flex'}`}>
              ...
              <div className="flex-1 overflow-y-auto">
                {chatsLoading && chats.length === 0 ? (
                  ...
                  <div className="p-8 text-center text-gray-500">
                    ...
                    <button
                      onClick={() => navigate('/marketplace')}
                      className="mt-3 px-4 py-2 text-sm text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors"
                    >
                      Browse Marketplace
                    </button>
                  </div>
            ...
            {/* Chat Interface - Right Panel (Wider) */}
            <div className={`flex-1 flex flex-col ${showChatListMobile && selectedChat ? 'hidden lg:flex' : 'flex'}`}>
              {selectedChat && selectedChat.otherUser ? (
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {selectedChat.order?._id && (
                        <button
                          ...
                          className="hidden lg:flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors border border-gray-300"
                        >
                          View Order
                        </button>
                      )}
                ...
                <div className="flex-1 flex flex-col items-center justify-center p-8">
                  {chats.length === 0 ? (
                    ...
                    <>
                      <div className="w-32 h-32 bg-gradient-to-br from-gray-50 to-gray-100 rounded-full flex items-center justify-center mb-6 border border-gray-200">
