...
const HypeModeProfile = () => {
  ...
  const registerUser = async (username: string, email: string, avatar: string, userType: string) => {
    try {
      const res = await axios.post('https://wecinema-co.onrender.com/api/user/signup', {
        username,
        email,
        avatar,
        userType,
  ...
  const loginUser = async (email: string) => {
    try {
      const res = await axios.post('https://wecinema-co.onrender.com/api/user/signin', { email });
