...
export { default as BookmarkVideosPage } from "./bookmarkvideos";
export { default as BookmarkScriptsPage } from "./bookmarkscripts";
...
export { default as Videos   } from "./admin/Videos";
