...
const WelcomeCard: React.FC<WelcomeCardProps> = ({
  ...
  return (
    <div className="bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 rounded-3xl shadow-2xl p-8 text-white overflow-hidden border border-gray-800/50">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-4">
              <button
                ...
                className="px-6 py-3.5 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white font-semibold rounded-xl hover:from-yellow-600 hover:to-yellow-700 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center group"
              >
              ...
              {secondaryAction?.visible && (
                <button
                  ...
                  className="px-6 py-3.5 bg-gray-800/50 text-white font-semibold rounded-xl hover:bg-gray-700/50 transition-all duration-300 border border-gray-700 hover:border-gray-600 flex items-center backdrop-blur-sm group"
                >
                  <svg className="w-5 h-5 mr-2 text-yellow-300 transition-transform group-hover:scale-110" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
