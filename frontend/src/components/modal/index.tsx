				...
				{isShow && show && (
					<>
						<div className={`fixed inset-0 z-50 flex justify-center items-start overflow-y-auto py-4 ${className || ""}`}>
							...
							{type === "login" && (
								<div className="relative z-50 pt-20 w-full flex justify-center items-start py-8 px-4">
									<motion.div
										initial={{ opacity: 0, scale: 0.95, y: 20 }}
										animate={{ opacity: 1, scale: 1, y: 0 }}
										exit={{ opacity: 0, scale: 0.95, y: 20 }}
							...
							{type === "logout" && (
								<div className="relative z-50 pt-40 w-full flex justify-center items-start py-8 px-4">
									<motion.div
										initial={{ opacity: 0, scale: 0.95, y: 20 }}
										animate={{ opacity: 1, scale: 1, y: 0 }}
										exit={{ opacity: 0, scale: 0.95, y: 20 }}
