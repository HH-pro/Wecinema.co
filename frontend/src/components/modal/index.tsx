  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-0 w-[100%] max-w-md sm:w-2/5 bg-white/30 border border-white/40 backdrop-blur-xl rounded-2xl shadow-[0_10px_40px_rgba(255,204,0,0.3)] p-8"
      >
        {/* Header */}
