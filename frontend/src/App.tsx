...
const AnimationStyles = memo(() => (
  <style>{`
    ...
    .animate-slide { animation: slide 1.5s infinite; }
          ...
          style={
            {
              ...
              animation: "pulse 1.5s ease-in-out var(--animation-delay) infinite",
            } as CSSProperties
          }
        />
      ))}
      ...
      <div className="relative flex flex-col items-center justify-center p-8">
        ...
        <div className="w-80 md:w-96 mb-8">
          <div className="relative h-3 bg-gray-200 rounded-full overflow-hidden shadow-inner">
            <div className="absolute top-0 left-0 h-full w-full bg-gradient-to-r from-yellow-400 via-amber-500 to-orange-500 rounded-full animate-shimmer" />
            <div className="absolute top-0 left-0 h-full w-1/3 bg-gradient-to-r from-transparent via-white/50 to-transparent rounded-full blur-sm animate-slide" />
          </div>
        ...
        <div className="absolute bottom-8 text-center">
          <p className="text-gray-400 text-sm">© 2026 WeCinema. All rights reserved.</p>
        </div>
      </div>
    </div>
  </>
